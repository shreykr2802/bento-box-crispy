...
<div class="detail-icons">
	...
	{:else if iconName === 'react'}
		...
		>
	{:else if iconName === 'en'}
		<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ff3131"
			><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
				id="SVGRepo_tracerCarrier"
				stroke-linecap="round"
				stroke-linejoin="round"
	...
	{:else if iconName === 'dev'}
		<svg
			...
			></g><g id="SVGRepo_iconCarrier">
				...
				>
					<path
						style="opacity:1;fill:#ff3131;fill-opacity:1;stroke:none;stroke-width:1.99999988;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:0.7716895"
					...
					<g
						aria-label="</>"
						style="font-style:normal;font-weight:normal;font-size:12.12121201px;line-height:1.25;font-family:sans-serif;letter-spacing:0px;word-spacing:0px;fill:#ff3131;fill-opacity:1;stroke:none;stroke-width:0.99999994"
						id="text1069"
						transform="translate(-1.0255685,2e-5)"
					></g>
				</g>
			</g></svg
		>
		...
		<svg
			...
			></g><g id="SVGRepo_iconCarrier"
				><path
					...
					stroke-linecap="round"
				></path><path d="M10.83,32.23l21.27,11h.45l22.25-11" stroke-linecap="round"></path><path
					d="M10.83,44.94l21.27,11h.45l22.25-11"
					stroke-linecap="round"
				></path></g
			></svg
		>
	{:else if iconName === 'mern'}
		<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
			><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
				id="SVGRepo_tracerCarrier"
				stroke-linecap="round"
